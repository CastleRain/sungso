...
const defaultOutputPath = sourceDataPath('apartment-catalog.json');
const districtPath = publicDataPath('law-districts.json');

function usage() {
  return [
    'Usage: node services/homehunt/scripts/build-apartment-catalog.mjs <source.csv> [output.json]',
    '',
