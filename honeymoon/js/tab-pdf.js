...
const PDF_FILES = [
  {
    ...
    files: [
      ...
      { file: 'data/리조트별/임소희 님 - 270307 라야바이앳모스피어.pdf', label: '라야바이앳모스피어 견적서' },
  ...
  },
  {
    ...
    files: [
      ...
      { file: 'data/패키지/27년@특가 [몰디브-사이라군+SO믹스] 리조트 4박 EK,SQ [1-12]-H 0423.pdf',          label: '사이라군+SO믹스 특가 패키지' },
      { file: 'data/패키지/27년@특가 [몰디브-앳모스피어바루] 리조트 4박 EK,SQ [1-12]-H 0423.pdf',           label: '앳모스피어바루 특가 패키지' },
    ],
  },
];
