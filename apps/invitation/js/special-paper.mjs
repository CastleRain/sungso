...
export function paperCover(templateId, thumbnail = false) {
  if (templateId === 'envelope') return `<div ${rootAttributes(templateId, thumbnail)}>
    ...
    <p class="couple-names paper-names">${names}</p><p class="paper-date">06 MARCH 2027</p>
  </div>`;
  ...
  if (templateId === 'camera') return `<div ${rootAttributes(templateId, thumbnail)}>
    ...
    <div class="camera-stage">
      <div class="instant-camera">
        ...
        <span class="camera-detail" aria-hidden="true">03<br>06</span>
      ...
      <div class="instant-print"><div class="instant-print-image">${PHOTOS.map((_, index) => photograph(index, thumbnail, `data-camera-photo="${index}"${index === 0 ? '' : ' hidden'}`)).join('')}</div><p>our happiest little moment <span aria-hidden="true">♡</span></p><span class="instant-print-date">2027. 03. 06 · SUNGWOO & SOHEE</span></div>
    </div>
    ...
    <div class="boarding-stage">
      <div class="boarding-pass">
        <div class="boarding-main"><div class="boarding-header"><span>BOARDING PASS</span>${plane}</div>
          ...
          <dl class="boarding-details"><div><dt>DEPARTURE</dt><dd>06 MAR 2027</dd></div><div><dt>DESTINATION</dt><dd>FOREVER</dd></div><div><dt>FLIGHT</dt><dd>SS 0306</dd></div><div><dt>SEAT</dt><dd>TOGETHER</dd></div></dl>
          <div class="boarding-stamp" aria-hidden="true"><span>OFFICIALLY</span><strong>MARRIED</strong><span>06 · MAR · 2027</span></div>
        </div>
