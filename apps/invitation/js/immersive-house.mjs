...
function miniature(thumbnail = false) {
  return `<div class="imm-art ih-art${thumbnail ? ' ih-miniature' : ''}" aria-hidden="true">
    ...
    <div class="ih-house">
      ...
      <div class="ih-front"><div class="ih-front-door ih-front-left"><span class="ih-front-window"></span><span class="ih-house-number">S & S</span><i></i></div><div class="ih-front-door ih-front-right"><span class="ih-front-window"></span><span class="ih-letter-slot"></span><i></i></div></div>
...
function weddingGarden() {
  return `<div class="imm-art ih-garden-art" aria-hidden="true"><div class="ih-garden-diorama">
    ...
    <div class="ih-gate ih-gate-left"><span></span><i></i><i></i><i></i><b>YOU</b></div><div class="ih-gate ih-gate-right"><span></span><i></i><i></i><i></i><b>+ ME</b></div>
...
export function houseBody(selection, parts) {
  ...
  return `${parts.cover || houseCover()}
    ...
    ${story ? scene('story', 'imm-stage ih-rooms', `${label('THREE ROOMS, ONE HEART')}<h2 class="imm-title">보통의 날을 담은<br><em>작은 방 세 개.</em></h2>${miniature()}${choices(rooms, '우리 집 이야기 방 선택')}<div class="ih-room-stories" aria-live="polite">${panel('living', '<span class="ih-room-number">ROOM 01 · LIVING</span><h3>하루의 끝에 만나는 우리</h3><p>각자의 하루를 가지고 돌아와<br>같은 소파에서 이야기를 나누는 저녁.<br>평범해서 더 좋아하는 미래예요.</p>', true)}${panel('photo', '<span class="ih-room-number">ROOM 02 · MEMORIES</span><h3>사진보다 더 오래 남는 것</h3><p>멋진 여행도, 우연한 산책도.<br>벽에 걸린 한 장의 사진 뒤에는<br>함께 웃었던 시간이 살고 있어요.</p>')}${panel('garden', '<span class="ih-room-number">ROOM 03 · GARDEN</span><h3>천천히 자라는 마음</h3><p>작은 화분을 돌보듯 서로를 아끼고,<br>새로운 계절이 찾아올 때마다<br>나란히 자라가는 우리가 되려고요.</p>')}</div><p class="ih-sample-note">함께 살아갈 날들을 그려본 이야기 예시입니다.</p>`, 2.2, 'house-rooms') : ''}
    ${scene('garden-promise', 'imm-stage ih-garden-invitation', `${label('THE GARDEN IS OPEN')}<h2 class="imm-title">이 작은 정원에서,<br><em>우리의 시작을.</em></h2>${weddingGarden()}<p class="imm-copy">소중한 얼굴들로 가득할 오월의 오후.<br>당신의 자리를 따뜻하게 준비할게요.</p>${unfoldButton('정원 문 활짝 열기')}<p class="ih-garden-postscript">THERE IS A PLACE FOR YOU HERE.</p>`, 2.4, 'house-garden')}
