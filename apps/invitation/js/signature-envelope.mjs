...
import { PHOTOS, getPhoto, contentDescription, hasPersonalPhotos, hasVenue } from './personal-content.mjs?v=20260915-venue-map';
import { escapeHtml } from './core.mjs?v=20260915-venue-map';
