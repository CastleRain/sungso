import { PHOTOS, SIGNATURES, getTemplate } from './catalog.mjs?v=20260913-signature';
import { escapeHtml as e } from './core.mjs?v=20260913-signature';
import { paperCover } from './special-paper.mjs?v=20260913-signature';
import { worldsCover } from './special-worlds.mjs?v=20260913-signature';
import { signatureBody } from './signatures.mjs?v=20260913-signature';
...
export function invitation(selection) {
  ...
  return `<article ${attributes} aria-label="${e(getTemplate(selection.templateId).name)} 전체 미리보기">${signatureBody(selection, parts)}</article>`;
}
