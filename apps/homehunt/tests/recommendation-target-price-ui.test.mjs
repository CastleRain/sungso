...
import { parseRecommendationQuery, parseKoreanMoneyToManWon, PYEONG_TO_M2 } from '../../../shared/homehunt/recommendation-core.mjs';
import { recommendationBudget, effectiveRecommendationDestinations } from '../js/personalized-context-core.mjs';
import { normalizeDestinations } from '../../../shared/homehunt/commute-balance-core.mjs';
import { rankPersonalizedCandidates } from '../js/personalized-ranking-core.mjs';
import { formatPriceManwon, formatCompactPrice } from '../../../shared/homehunt/display-format.mjs';
import { createHomeTargetPriceBridge } from '../../../shared/finance/home-target-price.mjs';
