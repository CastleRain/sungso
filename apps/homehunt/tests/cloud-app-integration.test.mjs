...
import { normalizeCloudSnapshot, CloudSnapshotError } from '../../../shared/homehunt/cloud-snapshot-core.mjs';
...
function configFor(hostname, api) {
  const context = vm.createContext({ FIREBASE_CONFIG, window: { location: { hostname } } });
