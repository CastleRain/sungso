...
import { normalizeRecommendationFilters, filterCatalogForRecommendation } from '../../../shared/homehunt/recommendation-core.mjs';
import { buildRecommendationPriceResult, recommendationMonthEvidence, recommendationMonthFailure,
  recommendationTaskKey } from '../../../services/homehunt/scripts/recommendation-data-safety.mjs';

const source = readFileSync(new URL('../../../services/homehunt/scripts/local-market-server.mjs', import.meta.url), 'utf8');
