...
import { connectedHistoryMonthLoader } from '../../../services/homehunt/scripts/history-request-lifecycle.mjs';
const require = createRequire(import.meta.url);
const { fetchApartmentHistoryDirect } = require('../../../services/homehunt/server/molit.cjs');
