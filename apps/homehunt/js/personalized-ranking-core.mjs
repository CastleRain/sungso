import { evaluateCommuteBalance, normalizeDestinations } from '../../../shared/homehunt/commute-balance-core.mjs';
...
import { transactionActivityDimension } from '../../../shared/homehunt/transaction-activity-core.mjs?v=4.18.0';
