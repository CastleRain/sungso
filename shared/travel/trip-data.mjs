// Shared March 2027 plan. Flights: user's 2026-09-13 screenshots; other quotes: 2026-09-12.
export const HOTELS = [
  {
    "id": "park",
    "name": "파크로열 컬렉션 마리나베이",
...
export const PLACES = {
  ...
  "maleAirport": {
    "name": "말레공항",
    "q": "Velana International Airport Maldives"
  },
  "hotel": {
    "name": "선택한 호텔"
  },
...
export const TRIP_DAYS = [
  ...
  },
  {
    ...
    "date": "2027-03-16",
    "label": "몰디브 밤 출발",
    "title": "섬에서의 마지막 하루, 밤 비행",
    "description": "몰디브 23:30 출발 → 다음 날 3/17 싱가포르 07:15 도착. 리조트에서 마지막 아침을 보내고 배정된 시간에 공항으로 이동해요.",
    "focus": "resort",
    "route": null,
    "events": [
      {
        "time": "오전",
        "title": "마지막 아침·짐 정리",
        "text": "조식과 산책 후 체크아웃을 준비해요. 리조트 출발 시간에 맞춰 여유 있게 정리해요.",
        "place": "resort"
      },
      {
        "time": "체크아웃 전후",
        "title": "체크아웃·이동 전 휴식",
        "text": "퇴실 시간, 점심·시설 이용, 짐 보관·샤워와 레이트 체크아웃 가능 여부·추가 비용을 리조트에 확인해요.",
        "place": "resort"
      },
      {
        "time": "리조트 배정 시간",
        "title": "리조트 → 말레 공항",
        "text": "23:30 국제선 출발을 전달하고 수상비행기 배정 시간·공항 도착 시간을 확인해요. 밤 항공편에 맞춰 리조트에서도 밤에 출발한다고 가정하지 않아요.",
        "place": "maleAirport"
      },
      {
        "time": "공항 도착 후",
        "title": "말레 공항 대기·저녁·출국 수속",
        "text": "수상비행기 도착부터 국제선까지 대기 시간을 확보해요. 식사·쉴 곳과 체크인 카운터 운영 시간은 별도 확인해요.",
        "place": "maleAirport"
      },
      {
        "time": "3/16 23:30 → 3/17 07:15",
        "title": "몰디브 → 싱가포르",
        "text": "싱가포르항공 후보 · 비행 4시간 45분. 모두 현지 시간이며 싱가포르에는 다음 날 도착해요."
      }
    ],
    "note": "몰디브 숙박은 3/12~16의 4박 계획을 유지해요. 늦은 항공편만으로 객실·식사·시설 이용이 연장되지는 않으니, 체크아웃 이후 조건과 수상비행기 시간을 함께 확인해요."
  },
  {
    "id": "home-2",
    "date": "2027-03-17",
    "label": "집으로",
    "title": "우리 집으로",
    "description": "07:15 싱가포르 도착 → 7시간 20분 환승 → 14:35 출발 → 22:00 인천 도착. 모두 현지 시간.",
    "focus": "airport",
    "route": null,
    "events": [
      {
        "time": "07:15",
        "title": "창이공항 도착",
        "text": "전날 23:30 몰디브에서 출발한 밤 비행 후 도착해요. 다음 항공편 터미널과 탑승구를 확인해요.",
        "place": "airport"
      },
      {
        "time": "07:15~14:35 · 7시간 20분",
        "title": "싱가포르 공항 환승·식사·휴식",
        "text": "공항에서 쉬며 연결편을 기다리는 계획이에요. 한 예약 연결 발권과 인천까지 수하물 연결 여부, 실제 탑승 마감 시간을 확인해요.",
        "place": "airport"
      },
      {
        "time": "14:35 → 22:00",
        "title": "싱가포르 → 인천",
        "text": "싱가포르항공 후보 · 비행 6시간 25분. 싱가포르 호텔 추가 숙박 없이 귀국해요."
      }
    ],
    "note": "인천에 밤 22:00 도착하는 일정이에요. 입국·수하물 수령 시간을 고려해 집까지 이동편을 준비해요. 항공편은 아직 구매 전 후보예요."
  }
];
...
export const DECISIONS = [
  ...
  },
  {
    "id": "flights",
    "title": "항공권 구매",
    "detail": "4구간·2인 3,355,600원 캡처 기준 후보 · 연결 발권 확인",
    "href": "travel/#flights",
    "status": "candidate"
  },
  {
